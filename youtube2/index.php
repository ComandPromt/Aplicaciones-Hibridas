...
<html>
    <head>
        <title>Buscar Video YouTube Data API V3</title>
    ...
    <body>
        <h2>Buscador Palabra Clave YouTube Data API V3</h2>
        <div class="search-form-container">
            <form id="keywordForm" method="post" action="">
                <div class="input-row">
                    Buscar Video : <input class="input-field" type="search" id="keyword" name="keyword"  placeholder="buscar...">
                </div>
        ...
        <?php
            ...
            <div class="result-heading"> <?php echo MAX_RESULTS; ?> Resultado</div>
